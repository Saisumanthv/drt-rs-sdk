...
First, download the [**Dharitri LLDB Pretty-Printer Script**](https://github.com/TerraDharitri/drt-sdk-rs/blob/master/tools/rust-debugger/pretty-printers/dharitri_sc_lldb_pretty_printers.py) to a known directory on your system.
