...
git = "https://github.com/dharitri/repo1"
...
by-git-commit-2 = { git = "https://github.com/dharitri/repo2", rev = "e990be823f26d1e7f59c71536d337b7240dc3fa2" }
    "#;
    ...
    fn test_dependency_value() {
        ...
        assert_eq!(
            raw_value,
            DependencyRawValue {
                git: Some("https://github.com/dharitri/repo1".to_owned()),
        ...
        assert_eq!(
            ...
            DependencyReference::GitCommit(GitCommitReference {
                git: "https://github.com/dharitri/repo1".to_owned(),
        ...
        assert_eq!(
            raw_value,
            DependencyRawValue {
                git: Some("https://github.com/dharitri/repo2".to_owned()),
        ...
        assert_eq!(
            raw_value.interpret(),
            DependencyReference::GitCommit(GitCommitReference {
                git: "https://github.com/dharitri/repo2".to_owned(),
